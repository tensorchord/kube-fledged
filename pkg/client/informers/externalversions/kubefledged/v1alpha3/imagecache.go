...
import (
	...
	v1alpha3 "github.com/senthilrch/kube-fledged/pkg/client/listers/kubefledged/v1alpha3"
...
type ImageCacheInformer interface {
	...
	Lister() v1alpha3.ImageCacheLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubefledgedV1alpha3().ImageCaches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubefledgedV1alpha3().ImageCaches(namespace).Watch(context.TODO(), options)
			},
		},
		&kubefledgedv1alpha3.ImageCache{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageCacheInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubefledgedv1alpha3.ImageCache{}, f.defaultInformer)
}

func (f *imageCacheInformer) Lister() v1alpha3.ImageCacheLister {
	return v1alpha3.NewImageCacheLister(f.Informer().GetIndexer())
}
